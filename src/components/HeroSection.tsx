...
const HeroSection: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    const fileId = '1enR7UgzmEQ9FiUIOnyyId2B4ZznF7w_u';
    const downloadUrl = `https://drive.google.com/uc?export=download&id=${fileId}`;
    const downloadLink = document.createElement('a');
    downloadLink.href = downloadUrl;
    downloadLink.download = 'harisundar_resume.pdf';
  ...
  return (
    <section
      id="home"
      className="relative h-screen w-full overflow-hidden flex items-center justify-center dark:bg-space-950 bg-space-50"
    >
      <ThreeScene />
      ...
      >
        ...
        >
          <span className="text-sm font-mono dark:text-nebula-400 text-nebula-600">
